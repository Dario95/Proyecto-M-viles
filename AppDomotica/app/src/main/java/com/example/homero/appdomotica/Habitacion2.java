...
public class Habitacion2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View vista = inflater.inflate(R.layout.fragment_habitacion2, container, false);
        obtenerDatosBackend();
        luz = (ToggleButton)vista.findViewById(R.id.tglHab2Luz);
        luz.setChecked(datosBackend[0]);
        ventilador = (ToggleButton)vista.findViewById(R.id.tglHab2Ventilador);
        ventilador.setChecked(datosBackend[1]);
        tv = (ToggleButton)vista.findViewById(R.id.tglHab2Tv);
